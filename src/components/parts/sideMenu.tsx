...
const SideMenu = () => {
  ...
  return (
    <nav id="spc-nav" className="relative">
      ...
      >
        <span
          className={`absolute left-0 w-10 h-0.5 ${isOpen ? 'bg-custom-vivid-green' : 'bg-custom-yellow'} top-0`}
        />
        <span
          className={`absolute left-0 w-10 h-0.5 ${isOpen ? 'bg-custom-vivid-green' : 'bg-custom-yellow'} top-3`}
        />
        <span
          className={`absolute left-0 w-10 h-0.5 ${isOpen ? 'bg-custom-vivid-green' : 'bg-custom-yellow'} top-6`}
        />
      </div>
